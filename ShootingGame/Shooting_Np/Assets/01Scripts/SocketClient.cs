...
public class SocketClient : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        handlerDictionary.Add("Shoot", gameManager.GetComponent<ShootHandler>());
        handlerDictionary.Add("OnDamage", gameManager.GetComponent<OnDamageHandler>());
        handlerDictionary.Add("Refresh", gameManager.GetComponent<RefreshHandler>());
        handlerDictionary.Add("Disconnect", gameManager.GetComponent<DisconnectedHandler>());
